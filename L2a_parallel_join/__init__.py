...
level on purpose: an eager `from .workflow import ...` here would import the module
during package import, and `python -m L2a_parallel_join.workflow` would then import it a
