...
level on purpose: an eager `from .desk import ...` here would import the module
during package import, and `python -m L3b_task_desk.desk` would then import it a
