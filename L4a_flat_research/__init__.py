...
level on purpose: an eager `from .deep_research import ...` here would import the module
during package import, and `python -m L4a_flat_research.deep_research` would then import it a
...
def __getattr__(name):
    if name == "root_agent":
        from .deep_research import l4a_workflow
        return l4a_workflow
